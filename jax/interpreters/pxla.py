...
def lower_mesh_computation(
    ...
    out_axes: Union[Sequence[ArrayMappingOrAuto], Callable[[], Sequence[ArrayMappingOrAuto]]],
    donated_invars: Sequence[bool],
    spmd_lowering: bool,
  ...
  auto_spmd_lowering = (any(_is_auto(i) for i in in_axes) and
                        any(_is_auto(o) for o in out_axes))  # type: ignore  # union-attr
